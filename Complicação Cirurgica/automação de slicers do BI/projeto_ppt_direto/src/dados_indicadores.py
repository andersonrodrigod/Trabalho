...
from core.gerar_slide_matplotlib import SheetTable
...
def _df_para_sheet_table(nome_aba: str, df: pd.DataFrame) -> SheetTable:
    headers = [
        "ESPECIALISTA",
...
def montar_tabelas_por_uf(
    ...
    for prefixo, coluna_pergunta, valor_alvo in blocos:
        ...
        tables_by_sheet[nome_geral] = _df_para_sheet_table(nome_geral, df_geral)
        ...
        for uf in ordem_ufs:
            ...
            tables_by_sheet[nome_aba] = _df_para_sheet_table(nome_aba, df_tabela)
