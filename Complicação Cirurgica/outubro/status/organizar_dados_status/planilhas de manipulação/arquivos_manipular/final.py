...
df_nomes = pd.read_excel("Nomes_tratados_comen_p4.xlsx")
...
df_nomes.to_excel("Nomes_tratados_com_CHAVE_CERTA_comen_p4.xlsx", index=False)

print("🎉 Concluído! Arquivo gerado: Nomes_tratados_com_CHAVE_CERTA_comen_p4.xlsx")