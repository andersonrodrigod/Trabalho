...
df_estado_atual = df_status_sorted.groupby("Contato", as_index=False).last() # duvida aqui
...
df_novos.loc[mask_chave, "IDENTIFICACAO"]             = df_novos.loc[mask_chave, "CHAVE RELATORIO"].map(map_chave["Respondido"])
