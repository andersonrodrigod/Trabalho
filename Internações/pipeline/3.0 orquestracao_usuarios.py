...
def definir_acao(row):
    ...
    elif processo == "ENCERRAR_CONTATO_NAO_TEM_INTERESSE":
        return "CONTATO_NAO_TEM_INTERESSE"
...
mask_nao_tem_interesse = (
    ~mask_em_respondidos
    & (df_usuarios["RESPOSTA"] == "Não tenho interesse")
)
...
df_usuarios.loc[mask_nao_tem_interesse, "PROCESSO"] = "ENCERRAR_CONTATO_NAO_TEM_INTERESSE"
